...
class ContentEmitterReturningValuesCheckTest {

    private val emittersRuleAssertThat = assertThatRule { ContentEmitterReturningValuesCheck() }
        ...
        emittersRuleAssertThat(code)
            ...
            .hasLintViolationsWithoutAutoCorrect(
                LintViolation(
                    line = 2,
                    col = 5,
                    detail = ContentEmitterReturningValues.ContentEmitterReturningValuesToo,
                ),
                LintViolation(
                    line = 7,
                    col = 5,
